...
public class ListRoleActivity extends AppCompatActivity {
    ...
    private String loadUrl = "http://172.20.10.3:8080/api/v1/roles";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, loadUrl, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        roleAdapter = new RoleAdapter(ListRoleActivity.this, roles);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(ListRoleActivity.this, "Erreur de chargement des données", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        Button btnAjouterRole = findViewById(R.id.btnAjouterRole);
        btnAjouterRole.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Lorsque le bouton est cliqué, démarrez l'activité "AddRole"
                Intent intent = new Intent(ListRoleActivity.this, AddRoleActivity.class);
    ...
    private void deleteRole(final int position) {
        ...
        String url = "http://172.20.10.3:8080/api/v1/roles/" + roleId; // Remplacez ceci par l'URL de votre API pour supprimer une filière
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.DELETE, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(ListRoleActivity.this, "Role supprimé avec succès", Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(ListRoleActivity.this, "Erreur lors de la suppression du role", Toast.LENGTH_LONG).show();
                    }
                }
        );
    ...
    private void showOptionsDialog(final Role role) {
        ...
        builder.setNeutralButton("Modifier", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent updateIntent = new Intent(ListRoleActivity.this, UpdateRoleActivity.class);
                // Passez l'objet Role en utilisant putExtra
                updateIntent.putExtra("role_to_update", role);
