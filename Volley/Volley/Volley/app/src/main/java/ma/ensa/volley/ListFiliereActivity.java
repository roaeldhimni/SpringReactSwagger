...
import ma.ensa.volley.UpdateFiliereActivity;

public class ListFiliereActivity extends AppCompatActivity {
    private ListView listView;
    private ArrayList<Filiere> filieres;
    private String loadUrl = "http://172.20.10.3:8080/api/v1/filieres";
    ...
    private void deleteFiliere(final int position) {
        ...
        String url = "http://172.20.10.3:8080/api/v1/filieres/" + filiereId; // Remplacez ceci par l'URL de votre API pour supprimer une filière
    ...
    private void showOptionsDialog(final Filiere filiere) {
        ...
        builder.setNeutralButton("Modifier", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                updateIntent.putExtra("filiere_to_update", filiere);
